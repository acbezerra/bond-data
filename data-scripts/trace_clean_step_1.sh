...
#!/bin/bash
#PBS -N trace_pre_proc
#PBS -l nodes=1:ppn=10,mem=70g
#PBS -j oe
#PBS -V
#PBS -t 1-27
...
mkdir -p ~/BondPricing/bond-data/log_files/TRACE/$PBS_JOBID
export JULIAWORKDIR=~/BondPricing/bond-data/log_files/TRACE/$PBS_JOBID
...
julia trace_clean_step_1.jl $job_num >> $JULIAWORKDIR/batch.log 2>&1
